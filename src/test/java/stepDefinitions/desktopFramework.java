...
public class desktopFramework extends Utils  {
	
	@Given("User launch browser and type google.com")
	public void user_launch_browser_and_type_google_com() throws IOException {
	    // Write code here that turns the phrase above into concrete actions
		driver = getDesktopDriver();
		driver.get(getGlobalValue("desktopUrl"));
	}
	@When("user search for apple and press enter")
    public void user_search_for_apple_and_press_enter() throws IOException{
